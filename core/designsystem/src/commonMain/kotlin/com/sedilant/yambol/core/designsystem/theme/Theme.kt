...
/**
 * Platform-specific dynamic color scheme. Returns null if dynamic color is not
 * supported or not requested, in which case the static theme is used.
 */
@Composable
